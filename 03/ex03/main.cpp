...
/*   Updated: 2024/10/03 09:18:38 by likong           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void){
	...
	std::cout << "\n----------For Diamondtrap----------\n\n";
	DiamondTrap	defaultHeroD;
	DiamondTrap	copyHeroD(defaultHeroD);

	DiamondTrap	hero1D("hero1D");
	DiamondTrap	hero2D("hero2D");
	...
	hero1D.attack("hero2D");
	hero2D.takeDamage(30);
	hero2D.beRepaired(10);
	
	hero2D.attack("hero1D");
	hero1D.takeDamage(30);
	hero1D.attack("hero2D");
	hero2D.takeDamage(30);
	hero1D.beRepaired(0);
	hero2D.beRepaired(0);
